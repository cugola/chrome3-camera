...
#define PIPELINE "v4l2src device=/dev/video0 do-timestamp=true ! video/x-raw, framerate=20/1, width=800, height=448 ! videoflip method=horizontal-flip ! autovideoconvert ! fbdevsink sync=false"
